...
create_token_set(literal_tokens, srcMLParser::CHAR_START, srcMLParser::COMPLEX_NUMBER, srcMLParser::STRING_START, srcMLParser::CONSTANTS, srcMLParser::FALSETOKEN, srcMLParser::TRUETOKEN, srcMLParser::NULLPTR,
